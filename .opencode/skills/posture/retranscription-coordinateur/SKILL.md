...
|-------|---------|-----------------|----------------------|
| **orchestrator** | `agents/orchestrator.md` | L40 | Après `posture/coordination-only` |
| **orchestrator-dev** | `agents/orchestrator-dev.md` | L49 | Après `posture/coordination-only` |
| **auditor** | `agents/auditor.md` | L16 | Après `posture/coordination-only` |
